...
| Flow roles | 19 |
| Tests in the suite | 494 (452 pass + 42 skip without the Postgres container) |
| New tests this phase | 53 — 25 on the prompt pack, 24 on the IVR, 3 on the demo path, and one more generated diagram to keep fresh |
