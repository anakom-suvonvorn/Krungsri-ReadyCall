...
**62 diagrams** covering every part of Krungsri ReadyCall. Written to be read in order the
...
├─ *.svg                  ← 62 rendered diagrams (committed, so no tooling is needed to read them)
